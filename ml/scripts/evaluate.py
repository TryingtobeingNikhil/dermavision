...
from ml.src.models.metrics import compute_metrics, sensitivity_at_specificity
from ml.src.training.utils import load_config, get_device
from ml.src.visualization.plots import plot_confusion_matrix, plot_training_curves


def main():
    parser = argparse.ArgumentParser(description="DermaVision Evaluation")
    parser.add_argument("--config", type=str, default=str(repo_root / "ml" / "config" / "config.yaml"))

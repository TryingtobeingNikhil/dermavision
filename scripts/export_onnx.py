...
from src.training.utils import load_config, count_parameters


def export_to_onnx(
    model_path: str = "models/best_model.pth",
    output_path: str = "models/dermavision.onnx",
    image_size: int = 300,
    num_classes: int = 7,
...
def main():
    ...
    parser.add_argument("--output", type=str, default="models/dermavision.onnx")
